<form id="createTaskForm">
    <div class="bg-white p-6 rounded-lg shadow-md w-full sm:max-w-md mx-auto">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 h-24"></textarea>
        </div>
        <div class="mb-4">
        ...
        <div id="messages" class="block mb-4 text-red-600"></div>
